...
import UploadSupplierOnline from "../../components/Test";

export namespace PlaygroundContainer {
...
class PlaygroundContainer extends React.Component<PlaygroundContainer.Props, PlaygroundContainer.State> {
  componentDidMount() {
  ...
  componentWillReceiveProps(nextProps: PlaygroundContainer.Props) {
    // if (
