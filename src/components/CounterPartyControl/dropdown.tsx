...
export namespace CounterPartyDropdown {
...
class CounterPartyDropdown extends React.Component<CounterPartyDropdown.Props,CounterPartyDropdown.State> {
    constructor(props){
        super(props);
    ...
    static getDerivedStateFromProps(props:CounterPartyDropdown.Props,
        state:CounterPartyDropdown.State){
            if(props.value != state.value){
                return {
                    value:props.value
                } as CounterPartyDropdown.State
            }   
            return null;
    }
